import pandas as pd
from app.core import CIDADE_ESTADOS_ARQUIVO, NOME_ESTADO, CODE_ESTADO, CODE_REGIAO_INTERMEDIARIA, NOME_REGIAO_INTERMEDIARIA, CODE_REGIAO_IMEDIATA, NOME_REGIAO_IMEDIATA, CODE_CIDADE, CODE_CIDADE_COMPLETO, NOME_CIDADE, CODE_DISTRITO, CODE_DISTRITO_COMPLETO, NOME_DISTRITO
...
def traduzir_codigo(codigo : str):
    ...
    match tamanho_code:
        ...
        # distrito
        case 9:
            df = pd.read_parquet(CIDADE_ESTADOS_ARQUIVO, columns=[CODE_ESTADO, NOME_ESTADO, CODE_REGIAO_INTERMEDIARIA, NOME_REGIAO_INTERMEDIARIA, CODE_REGIAO_IMEDIATA, NOME_REGIAO_IMEDIATA, CODE_CIDADE, CODE_CIDADE_COMPLETO, NOME_CIDADE, CODE_DISTRITO, CODE_DISTRITO_COMPLETO, NOME_DISTRITO])
            df = df[df[CODE_DISTRITO_COMPLETO] == codigo_numero]
            return df.drop_duplicates()
